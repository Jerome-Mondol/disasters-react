    ...
    <div className="w-full bg-secondary flex justify-center border-b border-gray-300 h-20">
      <nav className="flex justify-between items-center w-[90%] relative">
        ...
        <div
          ...
          } sm:flex flex-col sm:flex-row items-center gap-5 lg:gap-10 absolute sm:static top-16 left-0 w-full sm:w-auto bg-secondary sm:bg-transparent p-5 sm:p-0 shadow-md sm:shadow-none`}
        >
          {navItems.map((item) => (
            <a
              href="#"

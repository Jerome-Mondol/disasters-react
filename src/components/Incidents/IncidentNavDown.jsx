...
// //           <NavLink to={"/incidentStarter"} className="bg-primary pr-15 px-5 py-3 rounded-md text-white text-sm font-bold cursor-pointer hover:bg-black hover:text-primary transition-all w-full md:w-auto whitespace-nowrap text-center">
// //               {props.btn}
// //           </NavLink>
// //         </div>
// //       </div>
...
//             className="bg-primary pr-15 px-5 py-3 rounded-md text-white text-sm font-bold cursor-pointer hover:bg-black hover:text-primary transition-all w-full md:w-auto whitespace-nowrap text-center"
//           >
//             {props.btn}
//           </NavLink>
//         </div>

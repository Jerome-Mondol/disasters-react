...
import { Card1, Card2 } from '../../../public/consts/consts';
        ...
        <div className='w-full flex flex-col lg:flex-row justify-between gap-10'>
          ...
          <div className='w-full lg:w-[60%]'>
            ...
            <div className='flex flex-col gap-10'>
              <div className='flex items-center gap-3'>
                <div className='w-[37px] h-[37px] rounded-full bg-[#f5f5f5] flex items-center justify-center'>
                  <img src='../../../public/assets/IncidentsPage/locationtag.png' className='text-[#72727a]' />
                </div>
                <div>
              ...
              <div className='flex items-center gap-3'>
                <div className='w-[37px] h-[37px] rounded-full bg-[#f5f5f5] flex items-center justify-center'>
                  <img src='../../../public/assets/IncidentsPage/cost.png' className='text-[#72727a]' />
                </div>
                <div>
            ...
            <div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5'>
                <MainCard img={Card1} icon='/img/building.png' iconText='Building' heading='Whitechapel Rd.' title='Tulare County, Los Angeles, CA 23415' int='$1,456,654.00' />
                <MainCard img={Card1} icon='/img/building.png' iconText='Building' heading='Whitechapel Rd.' title='Tulare County, Los Angeles, CA 23415' int='$1,456,654.00' />
                <MainCard img={Card1} icon='/img/building.png' iconText='Building' heading='Whitechapel Rd.' title='Tulare County, Los Angeles, CA 23415' int='$1,456,654.00' />
                <MainCard img={Card1} icon='/img/building.png' iconText='Building' heading='Whitechapel Rd.' title='Tulare County, Los Angeles, CA 23415' int='$1,456,654.00' />
              </div>
            ...
            <div>
              ...
              <div className='flex flex-col gap-5'>
                <LocationCard img={Card2} name="Activity name" int="$1,456,654.00" />
                <LocationCard img={Card1} name="Activity name" int="$1,456,654.00" />
              </div>
            </div>
            <br />
            <hr />
            ...
            <div>
              ...
              <div className='flex flex-col gap-5'>
                <LocationCard img={Card2} name="Document name" int="$1,456,654.00" />
                <LocationCard img={Card1} name="Document name" int="$1,456,654.00" />
              </div>
            </div>
          </div>
          {/* Incident Map */}
          <div className='w-full lg:w-[50%] lg:flex flex-col items-end'>
            <div className='text-start text-[14px] text-[#71717A]'>
              ...
              <img className='w-full lg:h-[503px] rounded-[10px] cursor-pointer' src="../../../public/assets/IncidentsPage/map.png" alt="" />
